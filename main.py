...
class Opensea(object):
    ...
    def press_key(self, number: int, key: Keys) -> None:
        """Clear text from input."""
        i=0
        while i < number:
            webdriver.ActionChains(self.driver).key_down(key).perform()
            webdriver.ActionChains(self.driver).key_up(key).perform()
            i += 1
    ...
    def opensea_login(self) -> None:
        ...
        self.element_clickable('//*[@id="__next"]/div/div[2]/nav/ul/div[2]/li/button')

        # Click on "Metamask" button in list of wallet.
        # print(len(self.element_visible(
        #     '//*[@id="__next"]/div/main/div/div/div/div[2]/ul')))
        # ul = len(self.element_visible(
        #     '//*[@id="__next"]/div/main/div/div/div/div[2]/ul'
        # ).find_elements(By.TAG_NAME, "li"))
        
        
        if self.element_visible('//*[@id="__next"]/div/aside[2]/div[2]/div/div[2]/ul/li[1]/button/div[2]/span').text  == "MetaMask":
            self.element_clickable('//*[@id="__next"]/div/aside[2]/div[2]/div/div[2]/ul/li[1]/button')
        if self.element_visible('//*[@id="__next"]/div/aside[2]/div[2]/div/div[2]/ul/li[2]/button/div[2]/span').text  == "MetaMask":
            self.element_clickable('//*[@id="__next"]/div/aside[2]/div[2]/div/div[2]/ul/li[2]/button')
        if self.element_visible('//*[@id="__next"]/div/aside[2]/div[2]/div/div[2]/ul/li[3]/button/div[2]/span').text  == "MetaMask":
            self.element_clickable('//*[@id="__next"]/div/aside[2]/div[2]/div/div[2]/ul/li[3]/button')
        # for li in range(ul):
        ...
        #         # print(self.element_visible(
        #         #         '//*[@id="__next"]/div/main/div/div/div/div[2]/ul/li[2]/a/div[2]/span').text)
        
        #         # self.element_clickable('//*[@id="__next"]/div[1]/main/div/div/div/div[2]/ul/li[3]/button')
        #         # if self.element_visible(
        #         #         '//*[@id="__next"]/div/div[1]/nav/ul/div[2]/li/button').text  != "MetaMask":
        #             # Click on Metamask button.
        #         self.element_clickable('//*[@id="__next"]/div/div[1]/nav/ul/div[2]/li/button')
        #         # if self.element_visible(
        #         #         '//*[@id="__next"]/div/main/div/div/div/div[2]/ul/li[2]/button/div[2]/span').text == 'MetaMask':
        #         #     # Click on Metamask button.
        ...
        #         # Click on Metamask button.
        #         self.element_clickable('//*[@id="__next"]/div[1]/main/div/div'
        #                                 f'/div/div[2]/ul/li[{li}]/a')
        #         print('wallet no go')
        #         # raise TE('Wallet doesn\'t exist')
    ...
    def metamask_sign4div(self) -> None:
        """Metamask confirm connection."""
        # Switch on MetaMask popup tab.
        self.driver.switch_to.window(self.driver.window_handles[2]) \
            if self.window_handles(2) else self.retry_login(0)
        # Click on "Sign" button.
        self.element_clickable(
            '//*[@id="app-content"]/div/div[3]/div/div[4]/button[2]')
        # Switch back to Opensea tab.
        self.driver.switch_to.window(self.driver.window_handles[1]) \
            if self.window_handles(1) else self.retry_login(0)        
